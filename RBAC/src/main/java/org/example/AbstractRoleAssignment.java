...
public abstract class AbstractRoleAssignment implements RoleAssignment {
    ...
    public String summary() {
        ...
        String reason = metadata.reason() != null ? "Reason: " + metadata.reason() : "";
    ...
    public String toString() {
        return String.format("AbstractRoleAssignment{id='%s', user=%s, role=%s}",
                assignmentId, user.username(), role.getName());
    }
}
